            ...
            >
                <div className="text-left">
                    <h2 className="text-4xl font-extrabold tracking-tight text-gray-800 leading-none ">
                        UNLOCK YOUR <span className="font-bold text-red-600">DREAM CAREER</span>
                    </h2>
                    ...
                    <p className="mt-4 text-xl text-gray-700  l font-medium">
                        I help Biopharma, Healthcare, & Life Science Executives <span className="font-bold text-red-600">GET PROMOTED</span> and <span className="font-bold text-red-600">EARN 20% MORE IN 90 DAYS</span>.
                    </p>
