          ...
          <div className="fixed bottom-4 right-4 z-40 flex flex-col gap-4 sm:right-4">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" viewBox="0 0 24 24">
                <path d="M22.23 0H1.77C.792 0 0 .774 0 1.729v20.542C0 23.226.792 24 1.77 24h20.46C23.208 24 24 23.226 24 22.271V1.729C24 .774 23.208 0 22.23 0zM7.07 20.452H3.554V9h3.516v11.452zM5.312 7.659c-1.127 0-2.04-.918-2.04-2.049 0-1.13.913-2.048 2.04-2.048s2.04.918 2.04 2.048c0 1.131-.913 2.049-2.04 2.049zM20.452 20.452h-3.516v-5.605c0-1.336-.027-3.058-1.863-3.058-1.863 0-2.148 1.454-2.148 2.957v5.706H9.928V9h3.375v1.561h.047c.47-.888 1.616-1.825 3.327-1.825 3.554 0 4.21 2.341 4.21 5.386v6.87z" />
              </svg>
            </a>
            <a
